...
defmodule GoogleApi.Storage.V1.Model.BucketLifecycleAction do
  @moduledoc """
  The action to take.

  ## Attributes

  - storageClass (String.t): Target storage class. Required iff the type of the action is SetStorageClass. Defaults to: `null`.

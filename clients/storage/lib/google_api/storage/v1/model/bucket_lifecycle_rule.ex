...
defmodule GoogleApi.Storage.V1.Model.BucketLifecycleRule do
  @moduledoc """
  

  ## Attributes

  - action (BucketLifecycleAction):  Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.Storage.V1.Model.BucketLifecycleRule do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:"condition", :struct, GoogleApi.Storage.V1.Model.BucketLifecycleCondition, options)

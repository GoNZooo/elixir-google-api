...
defmodule GoogleApi.Storage.V1.Api.Buckets do
  ...
  {:error, info} on failure
  """
  @spec storage_buckets_lock_retention_policy(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Storage.V1.Model.Bucket.t} | {:error, Tesla.Env.t}
  def storage_buckets_lock_retention_policy(connection, bucket, if_metageneration_match, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,

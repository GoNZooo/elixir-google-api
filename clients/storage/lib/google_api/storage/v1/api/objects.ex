...
defmodule GoogleApi.Storage.V1.Api.Objects do
  ...
  def storage_objects_copy(connection, source_bucket, source_object, destination_bucket, destination_object, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/storage/v1/b/{sourceBucket}/o/{sourceObject}/copyTo/b/{destinationBucket}/o/{destinationObject}", %{
  ...
  def storage_objects_rewrite(connection, source_bucket, source_object, destination_bucket, destination_object, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/storage/v1/b/{sourceBucket}/o/{sourceObject}/rewriteTo/b/{destinationBucket}/o/{destinationObject}", %{
         "sourceBucket" => URI.encode_www_form(source_bucket),
         "sourceObject" => URI.encode_www_form(source_object),
         "destinationBucket" => URI.encode_www_form(destination_bucket),
         "destinationObject" => URI.encode_www_form(destination_object)
